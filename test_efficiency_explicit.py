...
if order == 0 or order == 2:
    ...
    error_0, evals_0 = method_efficiency(y0, t0, tf, y_prime, parameters, adaptive_0, method_RK2_0, eps_0, norm, error_type, average_error, jacobian = jacobian)
